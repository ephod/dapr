...
from mnist_actor import MnistActor

app = FastAPI(title=f"{MnistActor.__name__}Service")
...
config.update_actor_type_configs(
    [
        ActorTypeConfig(
            actor_type=MnistActor.__name__,
...
async def startup_event():
    # Register virtual actor
    await actor.register_actor(MnistActor)
